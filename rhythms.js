//This is the main rhythms file.
//Add or remove rhythms here and the main list of rhythms will be updated.

var rhythms = {

//Each rhythm name is enclosed in quotes

"Balakulanyan": { audio : [], pcfiles : ["Bala Kuladyan.pcc"] },
...
"Fakoli": { audio : [], pcfiles : ["Fakoli - Wadaba.pcc"] },

"Ferabanka": { audio : [], pcfiles : ["ferabanka.pcc"] },

"Gbada": { audio : [], pcfiles : ["Gbada_skeleton_w_Wadaba_dununba_part.pcc"] },

"Gbereduka": { audio : [], pcfiles : ["Gbereduka_root.pcc"] },

"Ikankorota": { audio : [], pcfiles : ["Ikankorota.pcc"] },

"Kassa gbe (Simp)": { audio : ["Famoudou Konate - Kassa medley.mp3"], pcfiles : ["Kassa Simp w S_D var.pcc"] },
